    ...
    for scenario in [1, 2, 3]:
        ...
        if check_for_output_data(scenario, sim) == True:
            ...
            if os.path.exists(output_name) == False:
                ...
                for t in range(0, param['simulation_length'][0]):
                    ...
                    prvt[t,:] = [100 * sum(I)/len(meta),
                                ...
                                100 * sum(I & (meta.gender == 1) & (meta.age_group == 0))/sum( (meta.gender == 1) & (meta.age_group == 0)),
                                100 * sum(I & (meta.gender == 1) & (meta.age_group == 1))/sum( (meta.gender == 1) & (meta.age_group == 1)),
                                100 * sum(I & (meta.gender == 1) & (meta.age_group == 2))/sum( (meta.gender == 1) & (meta.age_group == 2)),
                                100 * sum(I & (meta.gender == 1) & (meta.age_group == 3) & (meta.age < 35))/max(1, sum( (meta.gender == 1) & (meta.age_group == 3) & (meta.age < 35) )),
                                100 * sum(I & (meta.gender == 1) & (meta.age_group == 3) & (meta.age > 35))/max(1, sum( (meta.gender == 1) & (meta.age_group == 3) & (meta.age > 35) )),
                                100 * sum(I & (meta.gender == 0) & (meta.age_group == 0))/sum( (meta.gender == 0) & (meta.age_group == 0) ),
                                100 * sum(I & (meta.gender == 0) & (meta.age_group == 1))/sum( (meta.gender == 0) & (meta.age_group == 1) ),
                                100 * sum(I & (meta.gender == 0) & (meta.age_group == 2))/sum( (meta.gender == 0) & (meta.age_group == 2) ),
