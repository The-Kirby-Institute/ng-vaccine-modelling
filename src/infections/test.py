...
for t in tqdm(range(0, n_days)):
    ...
    meta, partner_matrix, partner_expire, d0ti, d1ti, d2ti = prt.new_partnership(meta, partner_matrix, partner_expire, n, t)
    ...
    i0lt, i0ht, i1lt, i1ht, i2lt, i2ht = istat.update_infections_by_group(meta, t, i0lt, i0ht, i1lt, i1ht, i2lt, i2ht)

    # Update summary stats on the number of annual partners
    xt, g0t, g1t, g2t = pstat.update_cumulative_partners(meta, partner_matrix, partner_expire, t, n, xt, g0t, g1t, g2t)
...
ax[2, 0].plot(t, i2ht[:,0]/n_g, label = "Rectal")
ax[2, 0].plot(t, i2ht[:,1]/n_g, label = "Urethral")
ax[2, 0].plot(t, i2ht[:,2]/n_g, label = "Pharyngeal")
ax[2, 0].plot(t, i2ht[:,3]/n_g, label = "Removed")
ax[2, 0].plot(t, i2ht[:,4]/n_g, label = "Susceptible")
ax[2, 0].plot(t, i2ht[:,5]/n_g, label = "Exposed")
...
ax[2].set_xlabel("Number of sexual partners in last 12 months")
...
ax[2, 0].set_ylabel("Age 25-29")
ax[2, 0].set_xlabel("Duration (days)")
